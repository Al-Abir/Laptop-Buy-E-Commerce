...
const ProductDetails = () => {
  ...
  return (
    ...
    <div className="w-full md:w-1/2 p-6 space-y-4">
        ...
        <button className="w-full px-4 py-2 mt-4 bg-blue-500 hover:bg-blue-600 text-white font-medium text-lg rounded-lg shadow-md transition-transform transform hover:scale-105">
            ADD TO CART
        </button>
    </div>
</div>
